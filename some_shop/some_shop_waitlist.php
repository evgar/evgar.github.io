        ...
        <div class="margin-element-20"></div>
            <div class="col-md-3 col-sm-3 goods-details">
               <ul class="left-navigate-type-2 cart-nav-list">
                    ...
                    <li class="cart-menu col-sm-12 active">
                        <a href="" class="waitList">
                            <span class="order-number">Лист ожидания</span>
                            <span class="waitlist-info">+1</span>
                        </a>
                    </li>
                </ul>
            </div>
            <div class="col-sm-9 col-xs-12">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <ul class="list-inline waitList-filter">
                        <li>
                            <a class="all-goods">
               ...
               <div class="row">
                    <div class="col-sm-6 col-md-4 waitlist-item">
